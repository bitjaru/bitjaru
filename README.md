...
5 microservices (dual frontend / collection API / business backend / scheduler / admin) on Kubernetes.
...
Cross-platform mobile app (Capacitor) shipped to both stores. Windows agent syncing POS + tank sensors on site.
